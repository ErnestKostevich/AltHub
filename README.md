...
<p align="center">
  <img alt="версия 1.2" src="https://img.shields.io/badge/версия-1.2-8b6cff">
...
есть **`Самопроверка.ps1`**: 57 проверок, которые прогоняются одной кнопкой и
...
```
Пройдено 57 из 57 — всё в порядке.
```
...
| `Самопроверка.ps1` | 57 проверок кода, шифрования и вёрстки |
