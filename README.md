...
есть **`Самопроверка.ps1`**: 73 проверок, которые прогоняются одной кнопкой и
...
| `Самопроверка.ps1` | 73 проверок кода, шифрования и вёрстки |
| `Проверка моста.ps1` | Поднимает приём и стучится в него так же, как расширение |
...
Прогонит 73 проверок: синтаксис всех файлов, оба режима шифрования (включая
