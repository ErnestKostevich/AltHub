...
есть **`Самопроверка.ps1`**: 58 проверок, которые прогоняются одной кнопкой и
...
```
Пройдено 58 из 58 — всё в порядке.
```
...
| `Самопроверка.ps1` | 58 проверок кода, шифрования и вёрстки |
