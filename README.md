...
<p align="center">
  <img alt="версия 1.4" src="https://img.shields.io/badge/версия-1.4-8b6cff">
...
На чистой установке Roblox этого XML иногда ещё нет. Такое отсутствие больше
не блокирует запуск аккаунта: AltHub пишет предупреждение в журнал и открывает
Roblox с обычными настройками. Когда клиент создаст XML, персональные графика,
FPS, звук и режим окна применятся при следующем запуске. Ошибки уже
существующего файла по-прежнему не замалчиваются.
