...
есть **`Самопроверка.ps1`**: 69 проверок, которые прогоняются одной кнопкой и
...
| `Самопроверка.ps1` | 69 проверок кода, шифрования и вёрстки |
...
Прогонит 69 проверок: синтаксис всех файлов, оба режима шифрования (включая
