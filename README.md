...
<p align="center">
  <img alt="версия 1.4.1" src="https://img.shields.io/badge/версия-1.4.1-8b6cff">
...
> **Исправлено в 1.4.1:** AltHub создаёт файл настроек Roblox на компьютерах,
> где клиент сам его не создаёт. Пользователь подтвердил работу настроек на
> проблемном ноутбуке после проверки тестовой сборки.
