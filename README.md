...
есть **`Самопроверка.ps1`**: 61 проверка, которые прогоняются одной кнопкой и
...
```
Пройдено 61 из 61 — всё в порядке.
```
...
| `Самопроверка.ps1` | 61 проверка кода, шифрования и вёрстки |
