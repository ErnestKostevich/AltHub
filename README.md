...
есть **`Самопроверка.ps1`**: 60 проверок, которые прогоняются одной кнопкой и
...
| `Самопроверка.ps1` | 60 проверок кода, шифрования и вёрстки |
...
Прогонит 60 проверок: синтаксис всех файлов, оба режима шифрования (включая
