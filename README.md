...
есть **`Самопроверка.ps1`**: 77 проверок, которые прогоняются одной кнопкой и
...
| `Самопроверка.ps1` | 77 проверок кода, шифрования и вёрстки |
...
Прогонит 77 проверок: синтаксис всех файлов, оба режима шифрования (включая
