...
Основной — мастер, который забирает вход прямо из приложения Roblox
(описан в быстром старте). Остальные — в мастере под кнопкой **«Ещё способы»**.

| Способ | Когда удобен |
|---|---|
| **Из приложения Roblox** | Основной. Пароль не нужен: вход берётся из приложения, в котором ты уже сидишь. |
